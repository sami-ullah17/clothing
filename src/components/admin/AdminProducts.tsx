                    ...
                    >
                      ...
                      <td className="py-3.5 px-4">
                        <button
                          ...
                          className={`px-3 py-1 rounded-full text-[11px] font-bold border transition-all flex items-center gap-1.5 shadow-2xs ${
                            isInStock
                      ...
                      <td className="py-3.5 px-4 text-right">
                        <div className="flex items-center justify-end gap-1.5">
                          <button
                            ...
                            className="px-2 py-1 bg-neutral-100 hover:bg-neutral-900 hover:text-white text-neutral-800 rounded-lg transition-all inline-flex items-center gap-1.5 text-[11px] font-bold border border-neutral-200"
